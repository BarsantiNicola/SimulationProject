...
double Order::getIndex() const
{
    return this->index;
}

void Order::setIndex(double index)
{
    this->index = index;
}

double Order::getCreationTime() const
{
    return this->creationTime;
}

void Order::setCreationTime(double creationTime)
{
...
OrderDescriptor::OrderDescriptor() : omnetpp::cClassDescriptor("barkitchen::Order", "omnetpp::cMessage")
{
...
std::string OrderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Order *pp = (Order *)object; (void)pp;
    switch (field) {
        case 0: return double2string(pp->getIndex());
...
bool OrderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Order *pp = (Order *)object; (void)pp;
    switch (field) {
        case 0: pp->setIndex(string2double(value)); return true;
