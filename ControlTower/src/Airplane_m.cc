...
double Airplane::getQueueArrival() const
{
    return this->queueArrival;
}

void Airplane::setQueueArrival(double queueArrival)
{
...
AirplaneDescriptor::AirplaneDescriptor() : omnetpp::cClassDescriptor("controltower::Airplane", "omnetpp::cMessage")
{
...
int AirplaneDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='q' && strcmp(fieldName, "queueArrival")==0) return base+0;
...
std::string AirplaneDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Airplane *pp = (Airplane *)object; (void)pp;
    switch (field) {
        case 0: return double2string(pp->getQueueArrival());
        default: return "";
    }
}
...
bool AirplaneDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Airplane *pp = (Airplane *)object; (void)pp;
    switch (field) {
        case 0: pp->setQueueArrival(string2double(value)); return true;
