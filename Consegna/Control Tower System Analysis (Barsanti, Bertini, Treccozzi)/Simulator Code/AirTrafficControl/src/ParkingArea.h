 ...
 class ParkingArea : public omnetpp::cSimpleModule
  {
   private:
    ...
    simtime_t nextTakeoffTime;           //Take-off time of the next airplane
    cQueue* departQueue;                 //FIFO queue of airplanes waiting for take-off
   ...
   public:
    ...
    virtual void go();                   //Starts the take-off of the oldest plane in the departing queue (called by the ControlTower module)
  };
